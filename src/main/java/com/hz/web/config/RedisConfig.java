...
//        defaultCacheConfig.entryTtl(Duration.ofSeconds(30));
         ...
         */
        ParserConfig.getGlobalInstance().addAccept("com.swsk.lib.base.entity.");
        ParserConfig.getGlobalInstance().addAccept("com.geo.lib.entity.");

        ParserConfig.getGlobalInstance().addAccept("com.swsk.iot.entity.");
        ParserConfig.getGlobalInstance().addAccept("com.swsk.*.entity.");
        ParserConfig.getGlobalInstance().addAccept("com.swsk.base.entity.");
